...
\begin{tikzpicture}[font=\sffamily]
    ...
    \draw[thick, decorate, decoration={brace, amplitude=7pt}] (B) -- (C);
    \draw[thick, decorate, decoration={brace, amplitude=7pt}] (D) -- (C);
    \draw[thick, decorate, decoration={brace, amplitude=7pt}] (D) -- (E);
